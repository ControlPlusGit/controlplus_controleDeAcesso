 ...
 * EEPROM.
 */
EEPROM_24LC256_stats EEPROM_24LC256_I2C_read_uchar ( uint8_t i2c_address, uint16_t mem_address, uint8_t *data );

/* 
 * Fun��o que realiza a ESCRITA de um dado em um determinado endere�o dA mem�ria
 * EEPROM.
 */
EEPROM_24LC256_stats EEPROM_24LC256_I2C_write_uchar (uint8_t i2c_address ,uint16_t mem_address, uint8_t data);

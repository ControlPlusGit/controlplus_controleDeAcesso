...
#define TEMPO_AGUARDANDO_ACK_MSG_WIFI_ESP8266 10000 //20000 //MARCOS - DIMINUI TEMPO DE TENTATIVA DE CONEXﾃO.
                ...
                if(delayExecucao_ESP8266 < TEMPO_AGUARDANDO_ACK_ESP8266 + 5000){
                    ...
                    if(maquinaDeEstadosLiberada_ESP8266){
                       if(strstr(bufferInterrupcaoUART4,"ready")!=0){          
                             limpaBufferNaMaquinaDeEstados_ESP8266();
                             zeraContadorExecucao_FSM_ESP8266(); //MARCOS - ZEREI PARA REINICIAR PARA A PROXIMA FUNﾇﾃO
